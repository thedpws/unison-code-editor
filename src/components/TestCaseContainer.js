      ...
      <div className="grid grid-cols-8 bg-gray-300">
        ...
        <div className="col-span-7 bg-gray-500">
          ...
          >
            ...
            <OutputEditor
              defaultVal={props?.testCases[selectedCase - 1]?.stdin}
            />
          </div>
          <div
            style={{
          ...
          >
            ...
            <OutputEditor
              defaultVal={props?.testCases[selectedCase - 1]?.stdout}
            />
          </div>
          <div
            style={{
          ...
          >
            ...
            <OutputEditor
              defaultVal={props?.testCases[selectedCase - 1]?.stdout_expected}
            />
          </div>
        </div>
      </div>
